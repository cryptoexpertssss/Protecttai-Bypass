...
module.exports = {
    ...
    bootstrap: function() {
        ...
        var APP_PLUGIN_NAME = Number(cordova.platformVersion.split('.')[0]) >= 4 ? 'CoreAndroid_MWT' : 'App';
...
var APP_PLUGIN_NAME = Number(require('cordova').platformVersion.split('.')[0]) >= 4 ? 'CoreAndroid_MWT' : 'App';
