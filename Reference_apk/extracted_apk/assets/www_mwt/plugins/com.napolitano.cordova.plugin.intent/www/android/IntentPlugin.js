...
IntentPlugin.prototype.startActivity = function (successCallback, failureCallback, bundle) {
   ...
   //    cordova.exec(function (res) { }, function (err) { }, "IntentPlugin", "startActivity",bundle);
   };
