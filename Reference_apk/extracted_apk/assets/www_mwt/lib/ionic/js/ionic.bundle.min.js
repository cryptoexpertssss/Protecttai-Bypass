! function() {
    ...
    window.ionic = window.ionic || {}, window.ionic.views = {}, window.ionic.version = "1.0.0-rc.5",
        function(e) {
    ...
    function t(e, t, n) {
        ...
        return function(o) {
            ...
            var v, g, m = o.afterItemsNode,
                ...
                z = "PRIMARY",
                M = "SECONDARY",
                H = L ? "translate3d(SECONDARYpx,PRIMARYpx,0)" : "translate3d(PRIMARYpx,SECONDARYpx,0)",
                O = L ? "height: PRIMARYpx; width: SECONDARYpx;" : "height: SECONDARYpx; width: PRIMARYpx;",
                U = 0,
                q = 0,
                W = -1,
                F = -1,
            ...
            this.refreshLayout = function() {
                ...
                if ($.style[ionic.CSS.TRANSFORM] = H.replace(z, -l).replace(M, 0), U -= l, I.__clientHeight && I.__clientWidth || (I.__clientWidth = I.__container.clientWidth, I.__clientHeight = I.__container.clientHeight), (ee.onRefreshLayout || angular.noop)(), ee.refreshDirection(), Q(), !ie)
    ...
    c.factory("$ionicActionSheet", ["$rootScope", "$compile", "$animate", "$timeout", "$ionicTemplateLoader", "$ionicPlatform", "$ionicBody", "IONIC_BACK_PRIORITY", function(e, t, n, i, o, r, a, c) {
        ...
        return R.prototype.initialize = function(e) {
            ...
            register: function(e, t) {
                ...
                else if (R && R.stateId === u) z = R.viewId, O = R.historyId, M = B, R.historyId === $.historyId ? H = x : $ && (H = V, i = f(R.historyId), i && i.parentHistoryId === $.historyId ? H = E : (i = f($.historyId), i && i.parentHistoryId === d.parentHistoryId && (H = P)));
                ...
                if (v(z), L.backView && O == L.backView.historyId && u == L.backView.stateId && U == L.backView.url)
                    ...
                    create: function(t, l, h, T, E, L) {
                        var R, N, z, M = ++A,
                            H = {
                                ...
                                render: function(e, n) {
                                    if (z) ionic.Utils.reconnectScope(R.scope());
                                    else {
                                        p(R, x);
                                        var i = d(l, R, e.direction, h),
                                ...
                                transition: function(a, c, u) {
                                    ...
                                    var q = o.transitions.views[O.transition] || o.transitions.views.none,
                                        W = q(R, N, O.direction, O.shouldAnimate && u && L);
                                    if (W.shouldAnimate && (R.on($, w), R.data(k, e(b, D)), i.show(D)), E && (H.emit("before", O, U), p(R, x), W.run(0)), L && (C = n.defer(), P.push(C.promise)), E && L) e(v, 16);
                                    else {
    ...
    e.$inject = ["$ionicCollectionManager", "$parse", "$window", "$$rAF", "$rootScope", "$timeout"], t.$inject = ["$rootScope", "$window", "$$rAF"], c.directive("ionContent", ["$timeout", "$controller", "$ionicBind", "$ionicConfig", function(e, t, n, i) {
        return {
            ...
            compile: function(e, o) {
                ...
                var a, c;
                return e.addClass("scroll-content ionic-scroll"), "false" != o.scroll ? (a = h('<div class="scroll"></div>'), a.append(e.contents()), e.append(a)) : e.addClass("scroll-content-false"), {
                    pre: r
                }
            }
        }
